...
/**
 * <p>
 * This class extending android {@link android.app.Activity} class. To use this library, the common android class which extending
 * {@link android.app.Activity} class should replaced with extending {@link tunggiga.github.io.testsamsungtv.NSListener} class. The workflow of application will
 * not significantly changed since {@link tunggiga.github.io.testsamsungtv.NSListener} class also extending {@link android.app.Activity}.
 * </p>
 * <p>
 * {@link tunggiga.github.io.testsamsungtv.NSListener} provide abstract function or interface for another class in library to access/call the android
...
public abstract class NSListener {
	 ...
	 * </pre>
	 * 
	 * @param tag - Unique Identifier tag to differentiate between {@link tunggiga.github.io.testsamsungtv.NSListener} instance, Commonly use class name for identifier.
	 * 
	 * @since 1.0.0
	 * 
	 * */
